...
export class ADMINComponent {
  ...
  imageUrl: string = 'https://lorenzo-geano-etu.pedaweb.univ-amu.fr/extranet/CuisineLOLO/image/img%20(1).jfif';
  isLogin =false
  recetteFiltered: any;
  ...
  Deleterecette(thiss: any) {
    ...
    const url =
      'https://lorenzo-geano-etu.pedaweb.univ-amu.fr/extranet/CuisineLOLO/deleteRecette.php';
  ...
  Close_form_recette(newItem: boolean) {
    if ((newItem = true)) this.isAffiched = false;
  }
  Close_form_ingredient(newItem: boolean) {
    if ((newItem = true)) this.isAffichedIngredient = false;
  }
  ...
  // uploadFile() {
  //   console.log("file en train d'upload")
